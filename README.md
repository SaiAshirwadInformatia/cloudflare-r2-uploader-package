...
A simple Dart package to **upload files directly to Cloudflare R2** using AWS Signature Version 4 signing.
This package supports progress tracking, automatic MIME type detection, and returns the uploaded file URL on success.

---

## ✨ Features

- ✅ Upload files to Cloudflare R2 buckets
- ✅ AWS S3–compatible request signing
...
MIT License. See the [LICENSE](LICENSE "LICENSE") file for details.
